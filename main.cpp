...
int main(int argc, char** argv) {
	...
	switch (choice) {
	case 1: {
		MainCharacter = new Tactician("Choncc", 0, 2, 0); 
	}
		break;
	case 2: {
		MainCharacter = new Tactician("Ao Shin", 0, 2, 0);
	}
		break;
	case 3: {
		MainCharacter = new Tactician("Poro", 0, 2, 0);
	}
		break;
	case 4: {
		MainCharacter = new Tactician("Dowsie", 0, 2, 0);
	}
		break;
    case 5: {
		MainCharacter = new Tactician("Chibi Ahri", 0, 2, 0);
	}
		break;
    case 6: {
		MainCharacter = new Tactician("Chibi Ashe", 0, 2, 0);
	}
		break;
    case 7: {
		MainCharacter = new Tactician("Chibi Gwen", 0, 2, 0);
	}
		break;
    case 8: {
		MainCharacter = new Tactician("Chibi Teemo", 0, 2, 0);
	}
		break;
    case 9: {
		MainCharacter = new Tactician("Chibi Yone", 0, 2, 0);
	}
		break;
	default:
